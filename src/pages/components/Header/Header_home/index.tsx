        ...
        <div className={styles.header_content}>
          ...
          <div className={styles.header_icons}>
            <div className={styles.content_icons}>
              <Image href='/' class={styles.header_icon} src="/cart_icon.svg" width={40} height={40} />
              <Image href='#footer' class={styles.header_icon} src="/help_icon.svg" width={46} height={46} />
